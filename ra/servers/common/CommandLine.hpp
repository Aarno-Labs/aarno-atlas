...
#define OPT_ENABLE_SSL          1011
#define OPT_SSL_KEY_FILE        1012
#define OPT_SSL_CERT_FILE       1013
...
protected:
    ...
    vector<struct option> options = {
        ...
        { "sediment",          no_argument,      0, 'l' },
        { "ssl",               required_argument, &longopt, OPT_ENABLE_SSL},
        { "ssl-key-file",      required_argument, &longopt, OPT_SSL_KEY_FILE},
        { "ssl-cert-file",     required_argument, &longopt, OPT_SSL_CERT_FILE},
