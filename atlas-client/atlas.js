...
function print_usage_and_exit() {
    print("Usage: quickjs daemon.js --log --servers x --file input.js --offload offloads.txt\n" +
        ...
        // "only-faster   \t only offload if faster\n" +
        // "faster-check  \t faster check [default=6] \n" +
        // "faster-local  \t default local execution time in secs\n" +
        // "faster-remote \t default remote execution time in secs\n" +
...
function evaluate_args(opts) {
    ...
    // if (opts["only-faster"] != undefined) {
    //     globalThis.faster_only = true;
    // } else {
    //     globalThis.faster_only = false;
    // }

    // if (opts["faster-check"] != undefined) {
    //     globalThis.faster_check = parseInt(opts["faster-check"]);
    // } else {
    //     globalThis.faster_check = 6;
    // }

    // if (opts["faster-local"] != undefined) {
    //     globalThis.faster_local_secs = parseInt(opts["faster-local"]);
    // } else {
    //     globalThis.faster_local_secs = -1;
    // }

    // if (opts["faster-remote"] != undefined) {
    //     globalThis.faster_remote_secs = parseInt(opts["faster-remote"]);
    // } else {
    //     globalThis.faster_remote_secs = -1;
    // }
