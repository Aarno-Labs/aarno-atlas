...
function isRawRGBAData(obj) {
  // console.log(`${obj.data.length} === ${obj.width * obj.height * 4} || ${obj.data.length} === ${obj.width * obj.height * 3} ${obj.width} ${obj.height}`)
  // console.log(`${(0, _typeof2["default"])(obj) === 'object'} && ${typeof obj.width === 'number'} && ${typeof obj.height === 'number'} && (${Buffer.isBuffer(obj.data)} || ${obj.data instanceof Uint8Array} || (${typeof Uint8ClampedArray === 'function'} && ${obj.data instanceof Uint8ClampedArray})) && (${obj.data.length === obj.width * obj.height * 4} || ${obj.data.length === obj.width * obj.height * 3})`);
